...
name: code-review
description: >
  Orchestrates automated local code review by dispatching specialized agents
...
Runs automated code review on local changes by dispatching specialized agents in parallel, then printing findings to the terminal grouped by severity.
