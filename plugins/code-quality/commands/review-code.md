...
The optional argument is a git ref to diff against. Examples:

- `/review-code` — review all uncommitted changes
- `/review-code main` — review diff against `main`

Dispatch five specialized agents (general, types, simplify, security, async-perf) in parallel to analyze the diff, then print findings to the terminal grouped by severity.
